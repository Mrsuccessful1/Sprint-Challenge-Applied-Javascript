...
1. What is the DOM?
    ...
    (Document Object Model) A bridge between the content and the browser.

2. What is an event?

    Any detectable interaction with a webpage.

3. What is an event listener?

    A method that listens for specific events and produces a callback triggered by the event.

4. Why would we convert a NodeList into an Array?

    With an array you can utilize the ".forEach()" method to loop through data.

5. What is a component?

    Reusable code that can reproduce a function over and over again.
### Git Set up
